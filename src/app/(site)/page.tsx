    ...
    <div className="mx-auto max-w-6xl px-4 py-6">
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <main className="lg:col-span-2">
              ...
              <div>
                <span className="inline-flex items-center gap-1.5 text-xs font-bold text-navy-700">
                  <span
                    ...
                    style={{
                      backgroundColor: getCategoryMeta(lead.categorySlug).accent,
                    }}
                  />
          ...
          <Link
            href="/bakusoq"
            className="mt-6 flex items-center justify-between gap-3 rounded-md bg-navy-700 px-5 py-3.5 text-white transition-colors hover:bg-navy-600"
          >
            <span className="text-sm font-bold">
              解体見積もりを速く正確に ─ BAKUSOQのご紹介
            </span>
